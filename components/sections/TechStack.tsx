            ...
            <div className="max-w-7xl mx-auto relative z-10">
                ...
                <TechStackClient>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 auto-rows-fr">
                        ...
                        <div className="tech-card lg:col-span-1 lg:row-span-2 p-8 md:p-10 border border-[var(--color-border-subtle)] bg-gradient-to-br from-[var(--color-brand-charcoal)] to-[var(--color-brand-black)] flex flex-col justify-end min-h-[300px]">
                            <div className="w-12 h-12 rounded-lg bg-[var(--color-fire-core)] flex items-center justify-center mb-8 border border-[var(--color-fire-neon)] shadow-[0_0_30px_rgba(255,51,51,0.3)]">
                                <svg className="w-6 h-6 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" />
                                </svg>
                            </div>
                            <h3 className="text-3xl font-serif text-[var(--color-text-primary)] mb-4 leading-tight">
